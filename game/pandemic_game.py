...
class PandemicGame:
    ...
    def _load_map_config(self, difficulty):
        ...
        with open(config_path, 'r') as f:
            ...
            for map_config in maps_data:
                if map_config.get("id") == difficulty:
                    return map_config
            raise ValueError(f"Map with difficulty id '{difficulty}' not found in maps.json")
